...
class AppDecoration {
  ...
  static BoxDecoration get groupstylegray800 => BoxDecoration(
        color: ColorConstant.gray800,
      );
  static BoxDecoration get textstylepoppinssemibold151 => BoxDecoration(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            6.00,
          ),
  ...
  static BoxDecoration get textstylesfprodisplaybold16 => BoxDecoration(
