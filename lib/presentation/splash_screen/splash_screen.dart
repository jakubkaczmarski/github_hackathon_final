                                  ...
                                  children: [
                                    Padding(
                                        ...
                                        child: Container(
                                            ...
                                            width: getHorizontalSize(152.56),
                                                                    ...
                                                                    child: Container(
                                                                        ...
                                                                        decoration: BoxDecoration(
                                                                            ...
                                                                            borderRadius: BorderRadius.circular(getHorizontalSize(
                                                                                6.00))),
                                                                        child:
                                                                            Text("msg_get_started_by".tr, maxLines: null, textAlign: TextAlign.center, style: AppStyle.textstylepoppinssemibold15.copyWith(fontSize: getFontSize(15), letterSpacing: 0.90)))),
                                                                Padding(
                                                                    padding: EdgeInsets.only(
                                                                        top: getVerticalSize(
                                                                            18.00),
                                                                    ...
                                                                    child: GestureDetector(
                                                                        ...
                                                                        child: Container(alignment: Alignment.center, height: getVerticalSize(62.00), width: size.width, decoration: AppDecoration.textstylepoppinssemibold151, child: Text("msg_get_started_wit".tr, textAlign: TextAlign.center, style: AppStyle.textstylepoppinssemibold151.copyWith(fontSize: getFontSize(15), letterSpacing: 0.90)))))
                                                              ])))
                                                ])))
                                  ]))
                        ])))));
